    ...
    var createObject = function() {
      ...
      var cIABMListDocClient_Save = function() {
        ...
        for (var _i = 0; _i < _count; _i++) {
          ...
          register.getFields().add2(Cairo.Constants.PRE_ID, csTareaPrestacion.cSPRETAREALISTHORA, Cairo.Constants.Types.id);
      ...
      var loadCollection = function() {
        ...
        //'Proyecto Item
        c.setName(Cairo.Language.getText(2657, ""));
        ...
        c.setHelpValueProcess(m_tar_id);
      ...
      var load = function(us_id) {
        ...
        return Cairo.Database.getData("load[" + apiPath + "general/horalistdoc]", id).then(
          function(response) {
            ...
            if(response.data.id === Cairo.Constants.NO_ID) {
              ...
              while (!rs.isEOF()) {
                ...
                switch (Cairo.Database.valField(response.data, Cairo.Constants.LDP_ID)) {
                  ...
                  case K_PROYECTOITEM:
                    m_proyi_id = Cairo.Database.valField(response.data, Cairo.Constants.LDP_VALOR);
                    break;
                  ...
                  case K_OBJETIVO:
                    m_obje_id = Cairo.Database.valField(response.data, Cairo.Constants.LDP_VALOR);
                    break;
                  ...
                  case K_TAREA:
                    m_tar_id = Cairo.Database.valField(response.data, Cairo.Constants.LDP_VALOR);
                    break;
      ...
      var pShowMensajes = function() {
        ...
        sqlstmt = "sp_ParteDiarioGetTitleForDoc "+ csETablesTask.cSHORA.toString()+ ","+ horaId.toString();
        ...
        doctId = csETablesTask.cSHORA;
        infodoc = Cairo.Database.valField(rs.getFields(), "info_doc");

        sqlstmt = "sp_PartesDiarioGetForDoc "+ Cairo.Database.getUserId().toString()+ ","+ cUtil.getEmpId().toString()+ ","+ doctId.toString()+ ","+ horaId.toString();
        ShowNotes(Cairo.Language.getText(2658, "", infodoc), sqlstmt);
      ...
      var pAddMensaje = function() {
        ...
        parte.AddParteToDoc(csETablesTask.cSHORA, m_objList.Id, false);
      };
      ...
      self.initialize = function() {
        try {
          ...
          c_strLoad = Cairo.Language.getText(2655, "");
          //Error al cargar los parámetros de navegación de Hora
          c_ErrorSave = Cairo.Language.getText(2656, "");
