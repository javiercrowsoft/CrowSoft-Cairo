(function() {
  ...
  Cairo.module("Cobrador.Edit", function(Edit, Cairo, Backbone, Marionette, $, _) {
    ...
    var createObject = function() {
      ...
      self.save = function() {
        ...
        for(var _i = 0; _i < _count; _i++) {
          ...
          switch (property.getKey()) {
            case K_NAME:
              fields.add(C.COB_NAME, property.getValue(), Types.text);
              break;

            case K_CODE:
              fields.add(C.COB_CODE, property.getValue(), Types.text);
              break;
            ...
            case K_DESCRIP:
              fields.add(C.COB_DESCRIP, property.getValue(), Types.text);
              break;

            case K_COMISION:
              fields.add(C.COB_COMISION, Cairo.Util.val(property.getValue()), Types.double);
              break;

            case K_REL_ID:
              fields.add(C.REL_ID, Cairo.Util.val(property.getSelectId()), Types.id);
              break;
          }
        }
      ...
      self.getPath = function() {
        return "#general/cobrador/" + m_id.toString();
      };
      ...
      var load = function(id) {
        ...
        return DB.getData("load[" + m_apiPath + "general/cobrador]", id).then(
          function(response) {
    ...
    Edit.Controller.edit = function(id) {
      var editor = Cairo.Cobrador.Edit.Controller.getEditor();
    ...
    List.Controller = {
      list: function() {
        ...
        var createTreeDialog = function(tabId) {
          ...
          var editors = Cairo.Editors.cobradorEditors || Cairo.Collections.createCollection(null);
          Cairo.Editors.cobradorEditors = editors;
          ...
          //
          Cairo.addRegions({ cobradorTreeRegion: tabId });

          // create the dialog
          //
          Cairo.Tree.List.Controller.list(
            Cairo.Tables.COBRADOR,
            new Cairo.Tree.List.TreeLayout({ model: self.entityInfo }),
            Cairo.cobradorTreeRegion,
            self);
