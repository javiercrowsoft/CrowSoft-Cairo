  ...
  Cairo.module("Clearing.Edit", function(Edit, Cairo, Backbone, Marionette, $, _) {
    ...
    var createObject = function() {
      ...
      self.save = function() {
        ...
        for(var _i = 0; _i < _count; _i++) {
          ...
          switch (property.getKey()) {
            case K_NAME:
              fields.add(C.CLE_NAME, property.getValue(), Types.text);
              break;

            case K_CODE:
              fields.add(C.CLE_CODE, property.getValue(), Types.text);
              break;
            ...
            case K_DIAS:
              fields.add(C.CLE_DIAS, property.getValue(), Types.integer);
              break;
          }
        }
      ...
      var load = function(id) {
        ...
        return DB.getData("load[" + m_apiPath + "general/clearing]", id).then(
          function(response) {
