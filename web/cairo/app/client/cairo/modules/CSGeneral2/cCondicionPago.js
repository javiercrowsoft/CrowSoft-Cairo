(function() {
  ...
  Cairo.module("CondicionPago.Edit", function(Edit, Cairo, Backbone, Marionette, $, _) {
    ...
    var createObject = function() {
      ...
      self.copy = function() {
        ...
        var property = m_dialog.getProperties().item(C.CPG_CODE);
        property.setValue(Cairo.Constants.COPY_OF + property.getValue());

        m_dialog.showValue(m_dialog.getProperties().item(C.CPG_CODE));
      ...
      self.showDocDigital = function() {
        ...
        try {
          ...
          doc.setClientTable(C.CONDICION_PAGO);
      ...
      self.save = function() {
        ...
        register.setFieldId(C.CPG_ID);
        register.setTable(C.CONDICION_PAGO);

        register.setPath(m_apiPath + "general/condicionpago");
        ...
        for (var _i = 0; _i < _count; _i++) {
          ...
          switch (property.getKey()) {
            ...
            case K_CODE:
              fields.add(C.CPG_CODE, property.getValue(), Types.text);
              break;
            ...
            case K_TIPO:
              fields.add(C.CPG_TIPO, property.getListItemData(), Types.integer);
              break;
            ...
            case K_ESCONTADO:
              fields.add(C.CPG_ESCONTADO, property.getValue(), Types.boolean);
              break;

            case K_LIBRE:
              fields.add(C.CPG_ES_LIBRE, property.getValue(), Types.boolean);
              break;

            case K_ASIENTOXVTO:
              fields.add(C.CPG_ASIENTO_XVTO, property.getValue(), Types.boolean);
              break;
        ...
        return DB.saveTransaction(
          ...
          C_MODULE,
          getText(1092, "") // Error al grabar condicion de pago
      ...
      self.getPath = function() {
        return "#general/condicionpago/" + m_id.toString();
      };
      ...
      self.getTitle = function() {
        return getText(1093, ""); // Condiciones de Pago
      };
      ...
      self.deleteRow = function(key, row, lRow) {
        ...
        switch (key) {
          case K_ITEMS:
            id = val(Dialogs.cell(row, KI_CPGI_ID).getValue());
      ...
      var loadCollection = function() {
        ...
        elem = properties.add(null, C.CPG_CODE);
        elem.setType(T.text);
      ...
      var refreshCollection = function() {
        ...
        elem = properties.item(C.CPG_CODE);
        elem.setValue(m_code);
        ...
        return Cairo.Database.getData("load[" + m_apiPath + "general/retencion]", id).then(
          function(response) {
            ...
            if(response.data.id !== NO_ID) {
              ...
              m_id = valField(data, C.CPG_ID);
              m_name = valField(data, C.RET_NAME);
              m_code = valField(data, C.CPG_CODE);
      ...
      var saveItems = function(mainRegister) {
        ...
        transaction.setTable(C.CONDICION_PAGO_ITEM);
      ...
      var saveCatFiscal = function(mainRegister) {
        ...
        transaction.setTable(C.CONDICION_PAGO_CATEGORIA_FISCAL);
      ...
      var saveProvincias = function(mainRegister) {
        ...
        transaction.setTable(C.CONDICION_PAGO_PROVINCIA);
    ...
    Edit.Controller.edit = function(id) {
      var editor = Cairo.CondicionPago.Edit.Controller.getEditor();
  ...
  Cairo.module("CondicionPago.List", function(List, Cairo, Backbone, Marionette, $, _) {
