(function() {
  ...
  Cairo.General = {
    ...
    Constants: {
      ...
      DOC_RV_DESDE_PV: "doc_rv_desde_pv",
      DOC_RV_DESDE_OS: "doc_rv_desde_os",
      DOC_PV_DESDE_PRV: "doc_pv_desde_prv",
      DOC_TIPO_FACTURA: "doc_tipofactura",
      DOC_TIPO_PACKING_LIST: "doc_tipopackinglist",
      DOC_TIPO_ORDEN_COMPRA: "doc_tipoordencompra",
      DOC_ID_REMITO: "doc_id_remito",
      DOC_ID_STOCK: "doc_id_stock",
      DOC_GENERA_REMITO: "doc_generaremito",
      DOC_MUEVE_STOCK: "doc_muevestock",
      DOC_RC_DESDE_OC: "doc_rc_desde_oc",
      DOC_RV_BOM: "doc_rv_bom",
      DOC_RC_DESPACHO_IMPO: "doc_rc_despachoimpo",
      DOC_FV_SIN_PERCEPCION: "doc_fv_sinpercepcion",
      DOC_ST_CONSUMO: "doc_st_consumo",
      DOC_EDITAR_IMPRESOS: "doc_editarimpresos",
      DOC_LLEVA_FIRMA_PRINT0: "doc_llevaFirmaPrint0",
      DOC_ES_FACTURA_ELECTRONICA: "doc_esFacturaElectronica",

      DOC_ES_RESUMEN_BANCO: "doc_esresumenbco",
      DOC_ES_CREDITO_BANCO: "doc_escreditobanco",
      DOC_ES_VENTA_ACCION: "doc_esventaaccion",
      DOC_ES_VENTA_CHEQUE: "doc_esventacheque",
      DOC_ES_COB_CHEQUE_SGR: "doc_escobchequesgr",
      DOC_ES_COB_CAIDA_SGR: "doc_escobcaidasgr",
