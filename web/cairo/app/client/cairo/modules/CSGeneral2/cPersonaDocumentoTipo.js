  ...
  Cairo.module("PersonaDocumentoTipo.Edit", function(Edit, Cairo, Backbone, Marionette, $, _) {
    ...
    var createObject = function() {
      ...
      self.save = function() {
        ...
        register.setPath(apiPath + "general/personadocumentotipo");
      ...
      list: function() {
        ...
        var createTreeDialog = function(tabId) {
          ...
          self.destroy = function(id, treeId, branchId) {
            ...
            var apiPath = Cairo.Database.getAPIVersion();
            return Cairo.Database.destroy(apiPath + "general/personadocumentotipo", id, Cairo.Constants.DELETE_FUNCTION, "PersonaDocumentoTipo").success(
              function() {
                try {
                  var key = getKey(id);
                  if(editors.contains(key)) {
