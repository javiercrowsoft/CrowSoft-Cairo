(function() {
  ...
  Cairo.module("ClienteContactoTipo.Edit", function(Edit, Cairo, Backbone, Marionette, $, _) {
    ...
    var createObject = function() {
      ...
      self.save = function() {
        ...
        for(var _i = 0; _i < _count; _i++) {
          ...
          switch (property.getKey()) {
            case K_NAME:
              fields.add(C.CLICT_NAME, property.getValue(), Types.text);
              break;

            case K_CODE:
              fields.add(C.CLICT_CODE, property.getValue(), Types.text);
              break;

            case K_DESCRIP:
              fields.add(C.CLICT_DESCRIP, property.getValue(), Types.text);
              break;
      ...
      self.getPath = function() {
        return "#general/clientecontactotipo/" + m_id.toString();
      };
      ...
      var load = function(id) {
        ...
        return DB.getData("load[" + m_apiPath + "general/clientecontactotipo]", id).then(
          function(response) {
    ...
    Edit.Controller.edit = function(id) {
      var editor = Cairo.ClienteContactoTipo.Edit.Controller.getEditor();
