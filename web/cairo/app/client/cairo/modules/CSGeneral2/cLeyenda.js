      ...
      self.save = function() {
        ...
        for(var _i = 0; _i < _count; _i++) {
          ...
          switch (property.getKey()) {
            case K_NAME:
              fields.add(C.LEY_NAME, property.getValue(), Types.text);
              break;

            case K_CODE:
              fields.add(C.LEY_CODE, property.getValue(), Types.text);
              break;
            ...
            case K_TEXTO:
              fields.add(C.LEYTEXTO, property.getValue(), Types.text);
              break;
          }
        }
