...
//*TODO:** enum is translated as a new class at the end of the file Public Enum csE_RetencionTipo
      ...
      self.save = function() {
        ...
        register.setPath(apiPath + "general/retenciontipo");
      ...
      list: function() {
        ...
        var createTreeDialog = function(tabId) {
          ...
          self.destroy = function(id, treeId, branchId) {
            ...
            var apiPath = Cairo.Database.getAPIVersion();
            return Cairo.Database.destroy(apiPath + "general/retenciontipo", id, Cairo.Constants.DELETE_FUNCTION, "RetencionTipo").success(
              function() {
                try {
                  var key = getKey(id);
                  if(editors.contains(key)) {
