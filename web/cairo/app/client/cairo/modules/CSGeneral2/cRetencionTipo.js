      ...
      self.save = function() {
        ...
        for(var _i = 0; _i < _count; _i++) {
          ...
          switch (property.getKey()) {
            case K_NAME:
              fields.add(C.RETT_NAME, property.getValue(), Types.text);
              break;

            case K_CODE:
              fields.add(C.RETT_CODE, property.getValue(), Types.text);
              break;

            case K_DESCRIP:
              fields.add(C.RETT_DESCRIP, property.getValue(), Types.text);
              break;

            case K_GENERASICORE:
              fields.add(C.RETT_GENERA_SICORE, property.getValue(), Types.boolean);
              break;

            case K_CODIGOSICORE:
              fields.add(C.RETT_CODIGO_SICORE, property.getValue(), Types.text);
              break;
            ...
            case K_TIPO:
              fields.add(C.RETT_TIPO, property.getListItemData(), Types.integer);
              break;
          }
        }
