      ...
      self.save = function() {
        ...
        for(var _i = 0; _i < _count; _i++) {
          ...
          switch (property.getKey()) {
            case K_NAME:
              fields.add(C.CICO_NAME, property.getValue(), Types.text);
              break;

            case K_CODE:
              fields.add(C.CICO_CODE, property.getValue(), Types.text);
              break;

            case K_DESCRIP:
              fields.add(C.CICO_DESCRIP, property.getValue(), Types.text);
              break;
