(function() {
  ...
  Cairo.module("Cliente.Edit", function(Edit, Cairo, Backbone, Marionette, $, _) {
    ...
    var createObject = function() {
      ...
      var K_CONTACTOS = 29;
      var K_VEN_ID = 30;
      var K_CREDITOCTACTE = 31;
      var K_CREDITOTOTAL = 32;
      var K_CREDITOACTIVO = 33;
        ...
        for(var _i = 0; _i < _count; _i++) {
          ...
          switch (property.getKey()) {
            ...
            case K_CREDITOCTACTE:
              fields.add(C.CLI_CREDITOCTACTE, property.getValue(), Types.currency);
              break;
      ...
      var loadCollection = function() {
        ...
        var elem = properties.add(null, C.CLI_CREDITOCTACTE);
      ...
      var refreshCollection = function() {
        ...
        var property = properties.item(C.CLI_CREDITOCTACTE);
      ...
      var loadInformes = function(property) {
        ...
        for(var _i = 0; _i < m_data.informes.length; _i += 1) {
      ...
      var loadContactos = function(property) {
        ...
        for(var _i = 0; _i < m_data.contactos.length; _i += 1) {
      ...
      var loadSucursales = function(property) {
        ...
        for(var _i = 0; _i < m_data.sucursales.length; _i += 1) {
