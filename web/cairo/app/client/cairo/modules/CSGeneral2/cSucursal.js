(function() {
  ...
  Cairo.module("Sucursal.Edit", function(Edit, Cairo, Backbone, Marionette, $, _) {
    ...
    var createObject = function() {
      ...
      self.save = function() {
        ...
        for(var _i = 0; _i < _count; _i++) {
          ...
          switch (property.getKey()) {
            case K_NAME:
              fields.add(C.SUC_NAME, property.getValue(), Types.text);
              break;

            case K_CODE:
              fields.add(C.SUC_CODE, property.getValue(), Types.text);
              break;

            case K_DESCRIP:
              fields.add(C.SUC_DESCRIP, property.getValue(), Types.text);
              break;

            case K_NUMERO:
              fields.add(C.SUC_NUMERO, property.getValue(), Types.long);
              break;
      ...
      self.getPath = function() {
        return "#general/sucursal/" + m_id.toString();
      };
          ...
          switch (property.getKey()) {
            ...
            case K_NUMERO:
              if(Cairo.Util.valEmpty(property.getValue(), Types.long)) {
                return Cairo.Modal.showInfoWithFalse(getText(1461, ""));
      ...
      var load = function(id) {
        ...
        return DB.getData("load[" + m_apiPath + "general/sucursal]", id).then(
          function(response) {
    ...
    Edit.Controller.edit = function(id) {
      var editor = Cairo.Sucursal.Edit.Controller.getEditor();
    ...
    List.Controller = {
      list: function() {
        ...
        var createTreeDialog = function(tabId) {
          ...
          var editors = Cairo.Editors.sucursalEditors || Cairo.Collections.createCollection(null);
          Cairo.Editors.sucursalEditors = editors;
          ...
          //
          Cairo.addRegions({ sucursalTreeRegion: tabId });

          // create the dialog
          //
          Cairo.Tree.List.Controller.list(
            Cairo.Tables.SUCURSAL,
            new Cairo.Tree.List.TreeLayout({ model: self.entityInfo }),
            Cairo.sucursalTreeRegion,
            self);
