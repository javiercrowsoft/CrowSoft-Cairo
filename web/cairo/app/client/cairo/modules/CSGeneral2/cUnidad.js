  ...
  Cairo.module("Unidad.Edit", function(Edit, Cairo, Backbone, Marionette, $, _) {
    ...
    var createObject = function() {
      ...
      self.save = function() {
        ...
        for(var _i = 0; _i < _count; _i++) {
          ...
          switch (property.getKey()) {
            case K_NAME:
              fields.add(C.UN_NAME, property.getValue(), Types.text);
              break;

            case K_CODE:
              fields.add(C.UN_CODE, property.getValue(), Types.text);
              break;
      ...
      var load = function(id) {
        ...
        return DB.getData("load[" + m_apiPath + "general/unidad]", id).then(
          function(response) {
