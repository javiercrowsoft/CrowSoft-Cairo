(function() {
  ...
  Cairo.module("Escala.Edit", function(Edit, Cairo, Backbone, Marionette, $, _) {
    ...
    var createObject = function() {
      ...
      self.save = function() {
        ...
        register.setPath(apiPath + "general/escala");
      ...
      self.getPath = function() {
        return "#general/escala/" + m_id.toString();
      };
      ...
      var load = function(id) {
        ...
        var apiPath = Cairo.Database.getAPIVersion();
        return Cairo.Database.getData("load[" + apiPath + "general/escala]", id).then(
          function(response) {
    ...
    List.Controller = {
      list: function() {
        ...
        var createTreeDialog = function(tabId) {
          ...
          var editors = Cairo.Editors.escalaEditors || Cairo.Collections.createCollection(null);
          Cairo.Editors.escalaEditors = editors;

          // ListController properties and methods
          //
          self.entityInfo = new Backbone.Model({
            entitiesTitle: "Escalas",
            entityName: "escala",
            entitiesName: "escalas"
          });
          ...
          self.edit = function(id, treeId, branchId) {
            ...
            if(editors.contains(key)) {
              ...
              var editor = Cairo.Escala.Edit.Controller.getEditor();
          ...
          self.destroy = function(id, treeId, branchId) {
            ...
            var apiPath = Cairo.Database.getAPIVersion();
            return Cairo.Database.destroy(apiPath + "general/escala", id, Cairo.Constants.DELETE_FUNCTION, "Escala").success(
              function() {
                try {
                  var key = getKey(id);
                  if(editors.contains(key)) {
          ...
          //
          Cairo.addRegions({ escalaTreeRegion: tabId });
        ...
        // create the tab
        //
        Cairo.mainTab.showTab("Escalas", "escalaTreeRegion", "#general/escalas", createTreeDialog, closeTreeDialog, showTreeDialog);
