      ...
      self.save = function() {
        ...
        for(var _i = 0; _i < _count; _i++) {
          ...
          switch (property.getKey()) {
            case K_NAME:
              fields.add(C.CUEG_NAME, property.getValue(), Types.text);
              break;

            case K_CODE:
              fields.add(C.CUEG_CODE, property.getValue(), Types.text);
              break;

            case K_DESCRIP:
              fields.add(C.CUEG_DESCRIP, property.getValue(), Types.text);
              break;
            ...
            case K_TIPO:
              fields.add(C.CUEG_TIPO, property.getListItemData(), Types.integer);
              break;
