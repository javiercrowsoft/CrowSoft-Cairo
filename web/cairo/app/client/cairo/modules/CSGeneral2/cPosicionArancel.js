  ...
  Cairo.module("PosicionArancel.Edit", function(Edit, Cairo, Backbone, Marionette, $, _) {
    ...
    var createObject = function() {
      ...
      self.save = function() {
        ...
        for(var _i = 0; _i < _count; _i++) {
          ...
          switch (property.getKey()) {
            case K_NAME:
              fields.add(C.POAR_NAME, property.getValue(), Types.text);
              break;

            case K_CODE:
              fields.add(C.POAR_CODE, property.getValue(), Types.text);
              break;

            case K_DESCRIP:
              fields.add(C.POAR_DESCRIP, property.getValue(), Types.text);
              break;
            ...
            case K_TI_ID_DERECHOS:
              fields.add(C.TI_ID_DERECHOS, property.getSelectId(), Types.id);
              break;

            case K_TI_ID_ESTADISTICA:
              fields.add(C.TI_ID_ESTADISTICA, property.getSelectId(), Types.id);
              break;
          }
        }
      ...
      var load = function(id) {
        ...
        return DB.getData("load[" + m_apiPath + "general/posicionarancel]", id).then(
          function(response) {
            ...
            if(response.data.id !== NO_ID) {
              ...
              m_descrip = "";
              m_active = true;
              m_ti_id_derechos = NO_ID;
              m_ti_derechos = "";
              m_ti_id_estadisticas = NO_ID;
              m_ti_estadisticas = "";
