  ...
  Cairo.module("XxxxListDoc.Edit", function(Edit, Cairo, Backbone, Marionette, $, _) {
    ...
    var createObject = function() {
      ...
      var signDocument = function() {
        ...
        if(rcupId === NO_ID) { return; }

        var firmado = null;
        var docId = null;

        if(!DB.getData(mTesoreriaConstantes.RESOLUCIONCUPON, mTesoreriaConstantes.RCUP_ID, rcupId, mTesoreriaConstantes.RCUP_FIRMADO, firmado)) { return; }
        if(!DB.getData(mTesoreriaConstantes.RESOLUCIONCUPON, mTesoreriaConstantes.RCUP_ID, rcupId, mTesoreriaConstantes.DOC_ID, docId)) { return; }
      ...
      var showAsiento = function() {
        ...
        if(rcupId) {
          ...
          var asId = null;
          if(!DB.getData(mTesoreriaConstantes.RESOLUCIONCUPON, mTesoreriaConstantes.RCUP_ID, rcupId, mTesoreriaConstantes.AS_ID, asId)) { return; }
