  ...
  Cairo.module("XxxxListDoc.Edit", function(Edit, Cairo, Backbone, Marionette, $, _) {
    ...
    var createObject = function() {
      ...
      var load = function(us_id) {
        ...
        return Cairo.Database.getData("load[" + apiPath + "general/resolucioncuponlistdoc]", id).then(
          function(response) {
      ...
      var pShowMensajes = function() {
        ...
        sqlstmt = "sp_ParteDiarioGetTitleForDoc "+ csEDocumentoTipo.cSEDT_RESOLUCIONCUPON.toString()+ ","+ rcupId.toString();
        ...
        sqlstmt = "sp_PartesDiarioGetForDoc "+ Cairo.Database.getUserId().toString()+ ","+ cUtil.getEmpId().toString()+ ","+ doctId.toString()+ ","+ rcupId.toString();
        ShowNotes(Cairo.Language.getText(2235, "", infodoc), sqlstmt);
        //Notas sobre Resolución de Cupones & infodoc
      };
      ...
      var pAddMensaje = function() {
        ...
        parte.AddParteToDoc(csEDocumentoTipo.cSEDT_RESOLUCIONCUPON, m_objList.id, false);
      };
