  ...
  Cairo.module("XxxxListDoc.Edit", function(Edit, Cairo, Backbone, Marionette, $, _) {
    ...
    var createObject = function() {
      ...
      var loadCollection = function() {
        ...
        c.setHelpValueProcess(m_cob_id);
      ...
      var load = function(us_id) {
        ...
        return Cairo.Database.getData("load[" + apiPath + "general/cobranzalistdoc]", id).then(
          function(response) {
            ...
            if(response.data.id === Cairo.Constants.NO_ID) {
              ...
              while (!rs.isEOF()) {
                ...
                switch (Cairo.Database.valField(response.data, Cairo.Constants.LDP_ID)) {
                  ...
                  case K_COB_ID:
                    m_cob_id = Cairo.Database.valField(response.data, Cairo.Constants.LDP_VALOR);
              ...
              //'Error al cargar los párametros de navegación de Cobranzas
              strLoad = Cairo.Language.getText(2283, "");
              ...
              if(m_cob_id.Substring(0, 1).toUpperCase() != KEY_NODO) {
                if(!Cairo.Database.getData(mTesoreriaConstantes.COBRADOR, mTesoreriaConstantes.COB_ID, Cairo.Util.val(m_cob_id), mTesoreriaConstantes.COB_NAME, data, C_LoadFunction, C_MODULE, strLoad)) { return false; }
                m_cobrador = data;
              }
              if(m_doc_id.Substring(0, 1).toUpperCase() != KEY_NODO) {
      ...
      var cIABMListDocClient_Refresh = function() {
        ...
        sqlstmt = sqlstmt+ Cairo.Database.sqlString(m_cob_id)+ ",";
      ...
      var cIABMListDocClient_Save = function() {
        ...
        strError = Cairo.Language.getText(2282, "");
        ...
        for (var _i = 0; _i < _count; _i++) {
          ...
          register.getFields().add2(Cairo.Constants.PRE_ID, csTesoreriaPrestacion.cSPRETSRLISTCOBRANZA, Cairo.Constants.Types.id);
      ...
      self.initialize = function() {
        try {
          ...
          //' Cobranzas
          m_title = Cairo.Language.getText(2128, "");
      ...
      var pCreateMenu = function() {
        ...
        m_menuShowInfoCli = m_objList.AddMenu(Cairo.Language.getText(1594, ""));
        //'Agregar Nota
      ...
      var pGetCliId = function() {
        ...
        cobzId = m_objList.id;
        Cairo.Database.getData(mTesoreriaConstantes.COBRANZA, mTesoreriaConstantes.COBZ_ID, cobzId, mTesoreriaConstantes.CLI_ID, cliId);
      ...
      var pShowMensajes = function() {
        ...
        sqlstmt = "sp_ParteDiarioGetTitleForDoc "+ csEDocumentoTipo.cSEDT_COBRANZA.toString()+ ","+ cobzId.toString();
        ...
        sqlstmt = "sp_PartesDiarioGetForDoc "+ Cairo.Database.getUserId().toString()+ ","+ cUtil.getEmpId().toString()+ ","+ doctId.toString()+ ","+ cobzId.toString();
        ShowNotes(Cairo.Language.getText(2127, "", infodoc), sqlstmt);
        //Notas sobre Cobranzas  infodoc
      };
      ...
      var pAddMensaje = function() {
        ...
        parte.AddParteToDoc(csEDocumentoTipo.cSEDT_COBRANZA, m_objList.id, false);
      };
      ...
      var pFirmar = function() {
        ...
        if(cobzId == Cairo.Constants.NO_ID) { return; }

        var firmado = null;
        var docId = null;

        if(!Cairo.Database.getData(mTesoreriaConstantes.COBRANZA, mTesoreriaConstantes.COBZ_ID, cobzId, mTesoreriaConstantes.COBZ_FIRMADO, firmado)) { return; }
        if(!Cairo.Database.getData(mTesoreriaConstantes.COBRANZA, mTesoreriaConstantes.COBZ_ID, cobzId, mTesoreriaConstantes.DOC_ID, docId)) { return; }
        ...
        sqlstmt = "sp_DocCobranzaFirmar "+ cobzId.toString()+ ","+ us_id.toString();
        if(!Cairo.Database.openRs(sqlstmt, rs)) { return; }

        m_objList.sqlstmt = "sp_lsdoc_Cobranza";

        m_objList.RefreshLine(cobzId);
      ...
      var pShowAsiento = function() {
        ...
        if(cobzId) {
          ...
          var asId = null;
          if(!Cairo.Database.getData(mTesoreriaConstantes.COBRANZA, mTesoreriaConstantes.COBZ_ID, cobzId, mTesoreriaConstantes.AS_ID, asId)) { return; }
