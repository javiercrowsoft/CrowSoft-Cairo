  ...
  Cairo.module("XxxxListDoc.Edit", function(Edit, Cairo, Backbone, Marionette, $, _) {
    ...
    var createObject = function() {
      ...
      var load = function(us_id) {
        ...
        return Cairo.Database.getData("load[" + apiPath + "general/depositobancolistdoc]", id).then(
          function(response) {
            ...
            if(response.data.id === Cairo.Constants.NO_ID) {
              ...
              strLoad = Cairo.Language.getText(2239, "");
              //Error al cargar los parámetros de navegación el Depósito Bancario
      ...
      var cIABMListDocClient_Save = function() {
        ...
        strError = Cairo.Language.getText(2238, "");
        ...
        for (var _i = 0; _i < _count; _i++) {
          ...
          register.getFields().add2(Cairo.Constants.PRE_ID, csTesoreriaPrestacion.cSPRETSRLISTDEPOSITOBANCO, Cairo.Constants.Types.id);
      ...
      self.initialize = function() {
        try {
          ...
          //'Depósitos Bancarios
          m_title = Cairo.Language.getText(2130, "");
      ...
      var pShowMensajes = function() {
        ...
        sqlstmt = "sp_ParteDiarioGetTitleForDoc "+ csEDocumentoTipo.cSEDT_DEPOSITOBANCO.toString()+ ","+ dbcoId.toString();
        ...
        sqlstmt = "sp_PartesDiarioGetForDoc "+ Cairo.Database.getUserId().toString()+ ","+ cUtil.getEmpId().toString()+ ","+ doctId.toString()+ ","+ dbcoId.toString();
        ShowNotes(Cairo.Language.getText(2180, "", infodoc), sqlstmt);
        //Notas sobre Despósitos Bancarios infodoc
      };
      ...
      var pAddMensaje = function() {
        ...
        parte.AddParteToDoc(csEDocumentoTipo.cSEDT_DEPOSITOBANCO, m_objList.id, false);
      };
      ...
      var pFirmar = function() {
        ...
        if(dbcoId == Cairo.Constants.NO_ID) { return; }

        var firmado = null;
        var docId = null;

        if(!Cairo.Database.getData(mTesoreriaConstantes.DEPOSITOBANCO, mTesoreriaConstantes.DBCO_ID, dbcoId, mTesoreriaConstantes.DBCO_FIRMADO, firmado)) { return; }
        if(!Cairo.Database.getData(mTesoreriaConstantes.DEPOSITOBANCO, mTesoreriaConstantes.DBCO_ID, dbcoId, mTesoreriaConstantes.DOC_ID, docId)) { return; }
        ...
        sqlstmt = "sp_DocDepositoBancoFirmar "+ dbcoId.toString()+ ","+ us_id.toString();
        if(!Cairo.Database.openRs(sqlstmt, rs)) { return; }
      ...
      var pShowAsiento = function() {
        ...
        if(dbcoId) {
          ...
          var asId = null;
          if(!Cairo.Database.getData(mTesoreriaConstantes.DEPOSITOBANCO, mTesoreriaConstantes.DBCO_ID, dbcoId, mTesoreriaConstantes.AS_ID, asId)) { return; }
