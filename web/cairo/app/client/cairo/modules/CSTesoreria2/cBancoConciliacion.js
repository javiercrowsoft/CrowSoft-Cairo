(function() {
  ...
  Cairo.module("XxxxListDoc.Edit", function(Edit, Cairo, Backbone, Marionette, $, _) {
    ...
    var createObject = function() {
      ...
      var SAVE_ERROR = getText(3859, ""); // Error al grabar los párametros de navegación de Xxxx
      ...
      var cIABMListDocClient_Save = function() {
        ...
        for(var _i = 0; _i < _count; _i++) {
          ...
          register.getFields().add2(C.PRE_ID, csTesoreriaPrestacion.cSPRETSRLISTCONCILIACIONBCO, Cairo.Constants.Types.id);
