  ...
  Cairo.module("XxxxListDoc.Edit", function(Edit, Cairo, Backbone, Marionette, $, _) {
    ...
    var createObject = function() {
      ...
      var cIABMListDocClient_Save = function() {
        ...
        sqlstmt = "delete ListaDocumentoParametro  where pre_id = "+ csTesoreriaPrestacion.cSPRETSRLISTDEPOSITO_CUPON.toString()+ " and us_id = "+ m_us_id+ " and (emp_id is null or emp_id = "+ Cairo.Company.getId().toString()+ ")";
        ...
        for(var _i = 0; _i < _count; _i++) {
          ...
          switch (property.getKey()) {
            ...
            case K_TJC_ID:
              ...
              fields.add(Cairo.Constants.LDP_ID, K_TJC_ID, Types.integer);
          ...
          fields.add(C.PRE_ID, csTesoreriaPrestacion.cSPRETSRLISTDEPOSITO_CUPON, Types.id);
