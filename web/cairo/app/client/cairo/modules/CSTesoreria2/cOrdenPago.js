  ...
  Cairo.module("XxxxListDoc.Edit", function(Edit, Cairo, Backbone, Marionette, $, _) {
    ...
    var createObject = function() {
      ...
      var load = function(us_id) {
        ...
        return Cairo.Database.getData("load[" + apiPath + "general/ordenpagolistdoc]", id).then(
          function(response) {
            ...
            if(response.data.id === Cairo.Constants.NO_ID) {
              ...
              //'Error al cargar Orden dePago
              strLoad = Cairo.Language.getText(2246, "");
              ...
              if(m_prov_id.Substring(0, 1).toUpperCase() != KEY_NODO) {
                if(!Cairo.Database.getData(mTesoreriaConstantes.PROVEEDOR, mTesoreriaConstantes.PROV_ID, Cairo.Util.val(m_prov_id), mTesoreriaConstantes.PROV_NAME, data, C_LoadFunction, C_MODULE, strLoad)) { return false; }
                m_proveedor = data;
              }
              if(m_est_id.Substring(0, 1).toUpperCase() != KEY_NODO) {
      ...
      var cIABMListDocClient_Save = function() {
        ...
        strError = Cairo.Language.getText(2245, "");
        ...
        for (var _i = 0; _i < _count; _i++) {
          ...
          register.getFields().add2(Cairo.Constants.PRE_ID, csTesoreriaPrestacion.cSPRETSRLISTORDENPAGO, Cairo.Constants.Types.id);
      ...
      self.initialize = function() {
        try {
          ...
          //'Orden de Pago
          m_title = Cairo.Language.getText(1922, "");
      ...
      var pGetProvId = function() {
        ...
        opgId = m_objList.id;
        Cairo.Database.getData(mTesoreriaConstantes.ORDENPAGO, mTesoreriaConstantes.OPG_ID, opgId, mTesoreriaConstantes.PROV_ID, provId);
      ...
      var pShowMensajes = function() {
        ...
        sqlstmt = "sp_ParteDiarioGetTitleForDoc "+ csEDocumentoTipo.cSEDT_ORDENPAGO.toString()+ ","+ opgId.toString();
        ...
        sqlstmt = "sp_PartesDiarioGetForDoc "+ Cairo.Database.getUserId().toString()+ ","+ cUtil.getEmpId().toString()+ ","+ doctId.toString()+ ","+ opgId.toString();
        ShowNotes(Cairo.Language.getText(2201, "", infodoc), sqlstmt);
      ...
      var pAddMensaje = function() {
        ...
        parte.AddParteToDoc(csEDocumentoTipo.cSEDT_ORDENPAGO, m_objList.id, false);
      };
      ...
      var pFirmar = function() {
        ...
        if(opgId == Cairo.Constants.NO_ID) { return; }

        var firmado = null;
        var docId = null;

        if(!Cairo.Database.getData(mTesoreriaConstantes.ORDENPAGO, mTesoreriaConstantes.OPG_ID, opgId, mTesoreriaConstantes.OPG_FIRMADO, firmado)) { return; }
        if(!Cairo.Database.getData(mTesoreriaConstantes.ORDENPAGO, mTesoreriaConstantes.OPG_ID, opgId, mTesoreriaConstantes.DOC_ID, docId)) { return; }
      ...
      var pShowAsiento = function() {
        ...
        if(opgId) {
          ...
          var asId = null;
          if(!Cairo.Database.getData(mTesoreriaConstantes.ORDENPAGO, mTesoreriaConstantes.OPG_ID, opgId, mTesoreriaConstantes.AS_ID, asId)) { return; }
