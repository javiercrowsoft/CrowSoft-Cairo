  ...
  Cairo.module("XxxxListDoc.Edit", function(Edit, Cairo, Backbone, Marionette, $, _) {
    ...
    var createObject = function() {
      ...
      var load = function(us_id) {
        ...
        return Cairo.Database.getData("load[" + apiPath + "general/movimientofondolistdoc]", id).then(
          function(response) {
            ...
            if(response.data.id === Cairo.Constants.NO_ID) {
              ...
              //'Error al cargar Movimiento de Fondos
              strLoad = Cairo.Language.getText(2244, "");
      ...
      var cIABMListDocClient_Save = function() {
        ...
        strError = Cairo.Language.getText(2243, "");
        ...
        sqlstmt = "delete ListaDocumentoParametro  where pre_id = "+ csTesoreriaPrestacion.cSPRETSRLISTMOVIMIENTOFONDO.toString()+ " and us_id = "+ m_us_id+ " and (emp_id is null or emp_id = "+ cUtil.getEmpId().toString()+ ")";
        ...
        for (var _i = 0; _i < _count; _i++) {
          ...
          register.getFields().add2(Cairo.Constants.PRE_ID, csTesoreriaPrestacion.cSPRETSRLISTMOVIMIENTOFONDO, Cairo.Constants.Types.id);
      ...
      var pShowMensajes = function() {
        ...
        sqlstmt = "sp_ParteDiarioGetTitleForDoc "+ csEDocumentoTipo.cSEDT_MOVIMIENTOFONDO.toString()+ ","+ mfId.toString();
        ...
        sqlstmt = "sp_PartesDiarioGetForDoc "+ Cairo.Database.getUserId().toString()+ ","+ cUtil.getEmpId().toString()+ ","+ doctId.toString()+ ","+ mfId.toString();
        ShowNotes(Cairo.Language.getText(2194, "", infodoc), sqlstmt);
        //Notas sobre Movimientos de Fondo  & infodoc
      };
      ...
      var pAddMensaje = function() {
        ...
        parte.AddParteToDoc(csEDocumentoTipo.cSEDT_MOVIMIENTOFONDO, m_objList.id, false);
      };
      ...
      var pFirmar = function() {
        ...
        sqlstmt = "sp_DocFacturaCompraFirmar "+ mfId.toString()+ ","+ us_id.toString();
        if(!Cairo.Database.openRs(sqlstmt, rs)) { return; }

        m_objList.sqlstmt = "sp_lsdoc_MovientoFondo";

        m_objList.RefreshLine(mfId);
      ...
      self.initialize = function() {
        try {
          ...
          m_title = Cairo.Language.getText(2185, "");
