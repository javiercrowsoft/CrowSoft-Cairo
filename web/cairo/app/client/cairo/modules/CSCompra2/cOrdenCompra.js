(function() {
  ...
  Cairo.module("XxxxListDoc.Edit", function(Edit, Cairo, Backbone, Marionette, $, _) {
    ...
    var createObject = function() {
      ...
      var SAVE_ERROR = getText(2171, ""); // Error al grabar los párametros de navegación de Xxxx
      ...
      var cIABMListDocClient_Save = function() {
        ...
        sqlstmt = "delete ListaDocumentoParametro  where pre_id = "+ csComprasPrestacion.cSPRECPRALISTORDEN.toString()+ " and us_id = "+ m_us_id+ " and (emp_id is null or emp_id = "+ Cairo.Company.getId().toString()+ ")";
        ...
        for(var _i = 0; _i < _count; _i++) {
          ...
          fields.add(C.PRE_ID, csComprasPrestacion.cSPRECPRALISTORDEN, Types.id);
      ...
      var showFactura = function() {
        try {
          ...
          o.ShowFacturaOrden(getProvId(), getOcIds());
      ...
      var showRemito = function() {
        try {
          ...
          o.ShowRemito(getProvId(), getOcIds());
