  ...
  Cairo.module("XxxxListDoc.Edit", function(Edit, Cairo, Backbone, Marionette, $, _) {
    ...
    var createObject = function() {
      ...
      var cIABMListDocClient_Save = function() {
        ...
        sqlstmt = "delete ListaDocumentoParametro  where pre_id ="+ csComprasPrestacion.cSPRECPRALISTREMITO.toString()+ " and us_id = "+ m_us_id+ " and (emp_id is null or emp_id = "+ Cairo.Company.getId().toString()+ ")";
        ...
        for(var _i = 0; _i < _count; _i++) {
          ...
          fields.add(C.PRE_ID, csComprasPrestacion.cSPRECPRALISTREMITO, Types.id);
