(function() {
  ...
  Cairo.module("XxxxListDoc.Edit", function(Edit, Cairo, Backbone, Marionette, $, _) {
    ...
    var createObject = function() {
      ...
      var SAVE_ERROR = getText(2165, ""); // Error al grabar los párametros de navegación de Xxxx
      ...
      var load = function() {
        ...
        return DB.getData("load[" + m_apiPath + "general/remitocompralistdoc]", id).then(
          function(response) {
      ...
      var showFactura = function() {
        try {
          ...
          o.ShowFacturaRemito(getProvId(), getRcIds());
