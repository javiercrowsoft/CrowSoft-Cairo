(function() {
  ...
  Cairo.module("XxxxListDoc.Edit", function(Edit, Cairo, Backbone, Marionette, $, _) {
    ...
    var createObject = function() {
      ...
      var C_MODULE = "cLiquidacionListDoc";
      ...
      var cIABMListDocClient_Save = function() {
        ...
        var sqlstmt = null;
        sqlstmt = "delete ListaDocumentoParametro  where pre_id = "+ csPrePersonalPrestacion.cSPREPLISTLIQUIDACION.toString()+ " and us_id = "+ m_us_id;
        ...
        for (var _i = 0; _i < _count; _i++) {
          ...
          register.getFields().add2(Cairo.Constants.PRE_ID, csPrePersonalPrestacion.cSPREPLISTLIQUIDACION, Cairo.Constants.Types.id);
      ...
      var getCIABMListDocClient_Title = function() {
        ...
        return Cairo.Language.getText(4604, "");
      };
      ...
      var load = function(us_id) {
        ...
        return Cairo.Database.getData("load[" + apiPath + "general/liquidacionlistdoc]", id).then(
          function(response) {
      ...
      var pShowMensajes = function() {
        ...
        sqlstmt = "sp_ParteDiarioGetTitleForDoc "+ csEDocumentoTipo.cSEDT_LIQUIDACION.toString()+ ","+ fvId.toString();
        ...
        doctId = Cairo.Database.valField(rs.getFields(), mPersonalConstantes.DOCT_ID);
        infodoc = Cairo.Database.valField(rs.getFields(), "info_doc");

        sqlstmt = "sp_PartesDiarioGetForDoc "+ Cairo.Database.getUserId().toString()+ ","+ cUtil.getEmpId().toString()+ ","+ doctId.toString()+ ","+ fvId.toString();
      ...
      var pAddMensaje = function() {
        ...
        parte.AddParteToDoc(csEDocumentoTipo.cSEDT_LIQUIDACION, m_objList.ID, false);
      };
      ...
      var pGetDocFilter = function() {
        return "'{emp_id=0}doct_id = "+ csEDocumentoTipo.cSEDT_LIQUIDACION.toString()+ " or doct_id = "+ csEDocumentoTipo.cSEDT_NOTACREDITOVENTA.toString()+ " or doct_id = "+ csEDocumentoTipo.cSEDT_NOTADEBITOVENTA.toString()+ "'";
      };

      self.initialize = function() {
        try {

          c_strLoad = Cairo.Language.getText(4605, "");
          //Error al cargar los parámetros de navegación de liquidaciones de haberes
          c_ErrorSave = Cairo.Language.getText(4606, "");
