        ...
        for(var _i = 0; _i < _count; _i++) {
          ...
          switch (property.getKey()) {
            ...
            case K_EM_ID:
              ...
              fields.add(Cairo.Constants.LDP_ID, K_EM_ID, Types.integer);
          ...
          fields.add(C.PRE_ID, csPrePersonalPrestacion.cSPREPLISTLIQUIDACION, Types.id);
