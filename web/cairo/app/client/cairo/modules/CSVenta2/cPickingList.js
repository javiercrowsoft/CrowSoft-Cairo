  ...
  Cairo.module("XxxxListDoc.Edit", function(Edit, Cairo, Backbone, Marionette, $, _) {
    ...
    var createObject = function() {
        ...
        for(var _i = 0; _i < _count; _i++) {
          ...
          switch (property.getKey()) {
            ...
            case K_NRO_DOC:
              ...
              fields.add(Cairo.Constants.LDP_ID, K_NRO_DOC, Types.integer);
            ...
            case K_ZON_ID:
              fields.add(Cairo.Constants.LDP_VALOR, property.getSelectIntValue(), Types.text);
              fields.add(Cairo.Constants.LDP_ORDEN, 50, Types.integer);
              fields.add(Cairo.Constants.LDP_ID, K_ZON_ID, Types.integer);

              break;
          }

          fields.add(C.US_ID, m_us_id, Types.id);
          fields.add(C.PRE_ID, csVentasPrestacion.cSPREVTALISTPICKINGLIST, Types.id);
      ...
      var loadCollection = function() {
        ...
        c = m_dialog.getProperties().add(null, CV.PKL_NRODOC);
