        ...
        for(var _i = 0; _i < _count; _i++) {
          ...
          switch (property.getKey()) {
            ...
            case K_PER_ID:
              ...
              fields.add(Cairo.Constants.LDP_ID, K_PER_ID, Types.integer);
            ...
            case K_CAM_ID:
              ...
              fields.add(Cairo.Constants.LDP_ID, K_CAM_ID, Types.integer);

              break;
          }

          fields.add(C.US_ID, m_us_id, Types.id);
          fields.add(C.PRE_ID, csVentasPrestacion.cSPREVTALISTHOJARUTA, Types.id);
