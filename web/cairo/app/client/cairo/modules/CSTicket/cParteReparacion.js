  ...
  Cairo.module("XxxxListDoc.Edit", function(Edit, Cairo, Backbone, Marionette, $, _) {
    ...
    var createObject = function() {
      ...
      var load = function(us_id) {
        ...
        return Cairo.Database.getData("load[" + apiPath + "general/partereparacionlistdoc]", id).then(
          function(response) {
            ...
            if(response.data.id === Cairo.Constants.NO_ID) {
              ...
              m_sucursal = "";
              m_us_id2 = Cairo.Constants.NO_ID;
              m_usuario = "";
              ...
              if(m_us_id2.Substring(0, 1).toUpperCase() != KEY_NODO) {
                if(!Cairo.Database.getData(Cairo.Constants.USUARIO, Cairo.Constants.US_ID, Cairo.Util.val(m_us_id2), Cairo.Constants.US_NAME, data, C_LoadFunction, C_MODULE, strLoad)) { return false; }
                m_usuario = data;
              }
              if(m_prns_id.Substring(0, 1).toUpperCase() != KEY_NODO) {
      ...
      var pGetCliId = function() {
        ...
        prpId = m_objList.Id;
        Cairo.Database.getData(mTicketConstantes.PARTEREPARACION, mTicketConstantes.PRP_ID, prpId, mTicketConstantes.CLI_ID, cliId);
      ...
      var pShowMensajes = function() {
        ...
        sqlstmt = "sp_ParteDiarioGetTitleForDoc "+ csEDocumentoTipo.cSEDT_PARTEREPARACION.toString()+ ","+ prpId.toString();
        ...
        sqlstmt = "sp_PartesDiarioGetForDoc "+ Cairo.Database.getUserId().toString()+ ","+ cUtil.getEmpId().toString()+ ","+ doctId.toString()+ ","+ prpId.toString();
      ...
      var pAddMensaje = function() {
        ...
        parte.AddParteToDoc(csEDocumentoTipo.cSEDT_PARTEREPARACION, m_objList.Id, false);
      };
      ...
      var pShowDocAux = function() {
        ...
        if(prpId) {
          ...
          var stId = null;
          if(!Cairo.Database.getData(mTicketConstantes.PARTEREPARACION, mTicketConstantes.PRP_ID, prpId, mTicketConstantes.ST_ID, stId)) { return; }
