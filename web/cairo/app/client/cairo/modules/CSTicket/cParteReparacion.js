(function() {
  ...
  Cairo.module("XxxxListDoc.Edit", function(Edit, Cairo, Backbone, Marionette, $, _) {
    ...
    var createObject = function() {
      ...
      var C_MODULE = "cParteReparacionListDoc";
      ...
      var loadCollection = function() {
        ...
        //'Técnico
        c.setName(Cairo.Language.getText(1846, ""));
        c.setKey(K_US_ID);
        value = m_usuario;
        ...
        c.setHelpValueProcess(m_us_id2);
      ...
      var load = function() {
        ...
        return DB.getData("load[" + m_apiPath + "general/partereparacionlistdoc]", id).then(
          function(response) {
            ...
            if(response.data.id === NO_ID) {
              ...
              while (!rs.isEOF()) {
                ...
                switch (Cairo.Database.valField(response.data, Cairo.Constants.LDP_ID)) {
                  ...
                  case K_US_ID:
                    m_us_id2 = Cairo.Database.valField(response.data, Cairo.Constants.LDP_VALOR);
              ...
              strLoad = Cairo.Language.getText(2298, "");
              ...
              if(m_us_id2.Substring(0, 1).toUpperCase() != KEY_NODO) {
                if(!DB.getData(Cairo.Constants.USUARIO, Cairo.Constants.US_ID, Cairo.Util.val(m_us_id2), Cairo.Constants.US_NAME, data, C_LoadFunction, C_MODULE, strLoad)) { return false; }
                m_usuario = data;
              }
              if(m_prns_id.Substring(0, 1).toUpperCase() != KEY_NODO) {
              ...
              if(m_cont_id.Substring(0, 1).toUpperCase() != KEY_NODO) {
                if(!DB.getData(mTicketConstantes.CONTACTO, mTicketConstantes.CONT_ID, Cairo.Util.val(m_cont_id), mTicketConstantes.CONT_NAME, data, C_LoadFunction, C_MODULE, strLoad)) { return false; }
                m_contacto = data;
              }
              if(m_docId.Substring(0, 1).toUpperCase() != KEY_NODO) {
      ...
      var cIABMListDocClient_Save = function() {
        ...
        strError = Cairo.Language.getText(2297, "");
        ...
        sqlstmt = "delete ListaDocumentoParametro where pre_id ="+ csPreTicketPrestacion.cSPRETICKLISTPARTEREPARACION.toString()+ " and us_id = "+ m_us_id+ " and (emp_id is null or emp_id = "+ cUtil.getEmpId().toString()+ ")";
        ...
        for (var _i = 0; _i < _count; _i++) {
          ...
          register.getFields().add2(Cairo.Constants.PRE_ID, csPreTicketPrestacion.cSPRETICKLISTPARTEREPARACION, Cairo.Constants.Types.id);
      ...
      var pGetDocFilter = function() {
        return "'{emp_id=0}doct_id = "+ csEDocumentoTipo.cSEDT_PARTEREPARACION.toString()+ "'";
      };
      ...
      var pGetCliId = function() {
        ...
        prpId = m_dialog.getId();
        DB.getData(mTicketConstantes.PARTEREPARACION, mTicketConstantes.PRP_ID, prpId, mTicketConstantes.CLI_ID, cliId);

        return cliId;
      };

      var pGetPrpIds = function() {
      ...
      self.initialize = function() {
        try {
          ...
          m_title = Cairo.Language.getText(1843, "");
      ...
      var pShowDocAux = function() {
        ...
        if(prpId) {
          ...
          var stId = null;
          if(!DB.getData(mTicketConstantes.PARTEREPARACION, mTicketConstantes.PRP_ID, prpId, mTicketConstantes.ST_ID, stId)) { return; }
