(function() {
  ...
  Cairo.module("XxxxListDoc.Edit", function(Edit, Cairo, Backbone, Marionette, $, _) {
    ...
    var createObject = function() {
      ...
      var SAVE_ERROR = getText(2259, ""); // Error al grabar los párametros de navegación de Xxxx
      ...
      var load = function() {
        ...
        return DB.getData("load[" + m_apiPath + "general/stockclientelistdoc]", id).then(
          function(response) {
      ...
      var cIABMListDocClient_Save = function() {
        ...
        sqlstmt = "delete ListaDocumentoParametro  where pre_id ="+ csStockPrestacion.cSPRESTLISTSTOCKCLIENTE.toString()+ " and us_id = "+ m_us_id+ " and (emp_id is null or emp_id = "+ Cairo.Company.getId().toString()+ ")";
        ...
        for(var _i = 0; _i < _count; _i++) {
          ...
          fields.add(C.PRE_ID, csStockPrestacion.cSPRESTLISTSTOCKCLIENTE, Types.id);
      ...
      var showDocAux = function() {
        ...
        if(stCliId) {
          ...
          var stId = null;
          if(!DB.getData(mStockConstantes.STOCKCLIENTE, mStockConstantes.ST_CLI_ID, stCliId, mStockConstantes.ST_ID, stId)) { return; }
      ...
      var getCliId = function() {
        ...
        stCliId = m_dialog.getId();
        DB.getData(mStockConstantes.STOCKCLIENTE, mStockConstantes.ST_CLI_ID, stCliId, mStockConstantes.CLI_ID, cliId);

        return cliId;
      };

      var getStCliIds = function() {
