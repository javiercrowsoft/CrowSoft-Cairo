  ...
  Cairo.module("XxxxListDoc.Edit", function(Edit, Cairo, Backbone, Marionette, $, _) {
    ...
    var createObject = function() {
      ...
      var load = function(us_id) {
        ...
        return Cairo.Database.getData("load[" + apiPath + "general/stockclientelistdoc]", id).then(
          function(response) {
      ...
      var pShowMensajes = function() {
        ...
        stCliId = m_objList.Id;

        sqlstmt = "sp_ParteDiarioGetTitleForDoc "+ csEDocumentoTipo.cSEDT_STOCKCLIENTE.toString()+ ","+ stCliId.toString();
        ...
        sqlstmt = "sp_PartesDiarioGetForDoc "+ Cairo.Database.getUserId().toString()+ ","+ cUtil.getEmpId().toString()+ ","+ doctId.toString()+ ","+ stCliId.toString();
        ShowNotes(Cairo.Language.getText(2024, "", infodoc), sqlstmt);
        //Notas sobre Transferencias de Stock a Cliente " & infodoc
      };
      ...
      var pAddMensaje = function() {
        ...
        parte.AddParteToDoc(csEDocumentoTipo.cSEDT_STOCKCLIENTE, m_objList.Id, false);
      };
