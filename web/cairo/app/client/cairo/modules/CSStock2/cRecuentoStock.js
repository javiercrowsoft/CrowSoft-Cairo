(function() {
  ...
  Cairo.module("XxxxListDoc.Edit", function(Edit, Cairo, Backbone, Marionette, $, _) {
    ...
    var createObject = function() {
      ...
      // cRecuentoStockListDoc
      // 16-06-04

      var C_MODULE = "cRecuentoStockListDoc";
      ...
      var loadCollection = function() {
        ...
        c.setSelectFilter("'{emp_id=0}doct_id = "+ csEDocumentoTipo.cSEDT_RECUENTOSTOCK.toString()+ "'");
      ...
      var load = function(us_id) {
        ...
        return Cairo.Database.getData("load[" + apiPath + "general/recuentostocklistdoc]", id).then(
          function(response) {
            ...
            if(response.data.id === Cairo.Constants.NO_ID) {
              ...
              //'Error al carga los parámetros de navegación de Recuentos de Stock
              strLoad = Cairo.Language.getText(2256, "");
      ...
      var cIABMListDocClient_Refresh = function() {
        ...
        sqlstmt = "sp_lsdoc_RecuentoStocks ";
      ...
      var cIABMListDocClient_Save = function() {
        ...
        strError = Cairo.Language.getText(2255, "");
        ...
        for (var _i = 0; _i < _count; _i++) {
          ...
          register.getFields().add2(Cairo.Constants.PRE_ID, csStockPrestacion.cSPRESTLISTRECUENTOSTOCK, Cairo.Constants.Types.id);
      ...
      self.initialize = function() {
        try {
          ...
          //'Recuentos de Stocks
          m_title = Cairo.Language.getText(2007, "");
      ...
      var pShowMensajes = function() {
        ...
        sqlstmt = "sp_ParteDiarioGetTitleForDoc "+ csEDocumentoTipo.cSEDT_RECUENTOSTOCK.toString()+ ","+ rsId.toString();
        ...
        sqlstmt = "sp_PartesDiarioGetForDoc "+ Cairo.Database.getUserId().toString()+ ","+ cUtil.getEmpId().toString()+ ","+ doctId.toString()+ ","+ rsId.toString();
        ShowNotes(Cairo.Language.getText(2010, "", infodoc), sqlstmt);
        //Notas sobre Recuento de Stock (1)
      };
      ...
      var pAddMensaje = function() {
        ...
        parte.AddParteToDoc(csEDocumentoTipo.cSEDT_RECUENTOSTOCK, m_objList.Id, false);
      };
      ...
      var pShowDocAux = function() {
        ...
        if(rsId) {
          ...
          if(!Cairo.Database.getData(mStockConstantes.RECUENTOSTOCK, mStockConstantes.RS_ID, rsId, mStockConstantes.ST_ID1, stId1)) { return; }
          if(!Cairo.Database.getData(mStockConstantes.RECUENTOSTOCK, mStockConstantes.RS_ID, rsId, mStockConstantes.ST_ID2, stId2)) { return; }
