(function() {
  ...
  Cairo.module("XxxxListDoc.Edit", function(Edit, Cairo, Backbone, Marionette, $, _) {
    ...
    var createObject = function() {
      ...
      var SAVE_ERROR = getText(2265, ""); // Error al grabar los párametros de navegación de Xxxx
      ...
      var loadCollection = function() {
        ...
        elem.setSelectIntValue(m_pr_id);
      ...
      self.save = function() {
        ...
        register.setPath(apim_apiPathPath + "compras/facturacompras");
      ...
      var cIABMListDocClient_Save = function() {
        ...
        for(var _i = 0; _i < _count; _i++) {
          ...
          fields.add(C.PRE_ID, Cairo.Security.Actions.General.LIST_STOCKLOTE, Types.id);
