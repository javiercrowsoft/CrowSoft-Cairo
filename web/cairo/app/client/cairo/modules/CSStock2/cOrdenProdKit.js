(function() {
  ...
  Cairo.module("XxxxListDoc.Edit", function(Edit, Cairo, Backbone, Marionette, $, _) {
    ...
    var createObject = function() {
      ...
      var SAVE_ERROR = getText(3728, ""); // Error al grabar los párametros de navegación de Xxxx
      ...
      var loadCollection = function() {
        ...
        var elem = properties.add(null, C_FECHA_INI);
        elem.setType(Dialogs.PropertyType.date);
        // Fecha desde
        elem.setName(getText(1203, ""));
        elem.setKey(K_FECHA_INI);
        if(LenB(m_fechaIniV)) {
        ...
        var elem = properties.add(null, C_FECHA_FIN);
        elem.setType(Dialogs.PropertyType.date);
        // Fecha hasta
        elem.setName(getText(1204, ""));
        elem.setKey(K_FECHA_FIN);
        if(LenB(m_fechaFinV)) {
        ...
        elem.setSelectIntValue(m_docId);
        ...
        elem.setSelectIntValue(m_sucId);
        ...
        elem.setValue(value);
        elem.setSelectId(Cairo.Util.val(m_lgjId));
        elem.setSelectIntValue(m_lgjId);
        ...
        elem.setSelectIntValue(m_empId);
      ...
      var cIABMListDocClient_Save = function() {
        ...
        for(var _i = 0; _i < _count; _i++) {
          ...
          fields.add(C.PRE_ID, csStockPrestacion.cSPRESTLISTORDENPRODKIT, Cairo.Constants.Types.id);
      ...
      var createMenu = function() {
        ...
        m_objList.ClearMenu;
        // Agregar Nota
        m_menuAddNote = m_objList.addMenu(getText(1645, ""));
        // Ver Notas
