    ...
    var createObject = function() {
      ...
      var pShowDocAux = function() {
        ...
        if(stId) {
          ...
          if(!DB.getData(mStockConstantes.STOCK, mStockConstantes.ST_ID, stId, mStockConstantes.ID_CLIENTE, idCliente)) { return; }
          if(!DB.getData(mStockConstantes.STOCK, mStockConstantes.ST_ID, stId, mStockConstantes.DOCT_ID_CLIENTE, doctIdCliente)) { return; }
