  ...
  Cairo.module("XxxxListDoc.Edit", function(Edit, Cairo, Backbone, Marionette, $, _) {
    ...
    var createObject = function() {
      ...
      var load = function(us_id) {
        ...
        return Cairo.Database.getData("load[" + apiPath + "general/stocklistdoc]", id).then(
          function(response) {
            ...
            if(response.data.id === Cairo.Constants.NO_ID) {
              ...
              //'Error al cargar los parametros de navegación de Transferencias de Stock
              strLoad = Cairo.Language.getText(2264, "");
      ...
      var cIABMListDocClient_Save = function() {
        ...
        strError = Cairo.Language.getText(2268, "");
        ...
        for (var _i = 0; _i < _count; _i++) {
          ...
          register.getFields().add2(Cairo.Constants.PRE_ID, csStockPrestacion.cSPRESTLISTSTOCK, Cairo.Constants.Types.id);
      ...
      self.initialize = function() {
        try {
          ...
          m_title = Cairo.Language.getText(2270, "");
      ...
      var pShowMensajes = function() {
        ...
        sqlstmt = "sp_ParteDiarioGetTitleForDoc "+ csEDocumentoTipo.cSEDT_TRASFERENCIASTOCK.toString()+ ","+ stId.toString();
        ...
        sqlstmt = "sp_PartesDiarioGetForDoc "+ Cairo.Database.getUserId().toString()+ ","+ cUtil.getEmpId().toString()+ ","+ doctId.toString()+ ","+ stId.toString();
        ShowNotes("Notas sobre Transferencia de Stock "+ infodoc, sqlstmt);
      };
      ...
      var pAddMensaje = function() {
        ...
        parte.AddParteToDoc(csEDocumentoTipo.cSEDT_TRASFERENCIASTOCK, m_objList.Id, false);
      };
      ...
      var pShowDocAux = function() {
        ...
        if(stId) {
          ...
          if(!Cairo.Database.getData(mStockConstantes.STOCK, mStockConstantes.ST_ID, stId, mStockConstantes.ID_CLIENTE, idCliente)) { return; }
          if(!Cairo.Database.getData(mStockConstantes.STOCK, mStockConstantes.ST_ID, stId, mStockConstantes.DOCT_ID_CLIENTE, doctIdCliente)) { return; }

          if(idCliente == Cairo.Constants.NO_ID) {
            ...
            if(objEditName == "") {
              MsgWarning(Cairo.Language.getText(1956, "", doctIdCliente));
