...
object C {
  ...
  val RUBTID1 = "rubt_id1"
  val RUBTID2 = "rubt_id2"
  val RUBTID3 = "rubt_id3"
  val RUBTID4 = "rubt_id4"
  val RUBTID5 = "rubt_id5"
  val RUBTID6 = "rubt_id6"
  val RUBTID7 = "rubt_id7"
  val RUBTID8 = "rubt_id8"
  val RUBTID9 = "rubt_id9"
  val RUBTID10 = "rubt_id10"

  val RUBTIID1 = "rubti_id1"
  val RUBTIID2 = "rubti_id2"
  val RUBTIID3 = "rubti_id3"
  val RUBTIID4 = "rubti_id4"
  val RUBTIID5 = "rubti_id5"
  val RUBTIID6 = "rubti_id6"
  val RUBTIID7 = "rubti_id7"
  val RUBTIID8 = "rubti_id8"
  val RUBTIID9 = "rubti_id9"
  val RUBTIID10 = "rubti_id10"
  ...
  // ClienteContactoTipo
  val CLIENTECONTACTOTIPO = "ClienteContactoTipo"
  ...
  // Tabla Rubro Item
  val RUBROTABLAITEM = "RubroTablaItem"
  ...
  val PR_LLEVASTOCK = "pr_llevastock"
  val PR_SECOMPRA = "pr_secompra"
  val PR_SEVENDE = "pr_sevende"
  val PR_NO_REDONDEO = "pr_noredondeo"
  val PR_ESKIT = "pr_eskit"
  val PR_KIT_STOCK_XITEM = "pr_kitStkItem"
  val PR_KIT_RESUMIDO = "pr_kitResumido"
  val PR_KIT_IDENTIDAD = "pr_kitIdentidad"
  val PR_KIT_IDENTIDAD_XITEM = "pr_kitIdentidadXItem"
  val PR_KIT_LOTE = "pr_kitLote"
  val PR_KIT_LOTE_XITEM = "pr_kitLoteXItem"
  val PR_ES_LISTA = "pr_eslista"
  val PR_PORCINTERNOC = "pr_porcinternoc"
  val PR_PORCINTERNOV = "pr_porcinternov"
  val PR_X = "pr_x"
  val PR_Y = "pr_y"
  val PR_Z = "pr_z"
  val PR_TIENEHIJO = "pr_tienehijo"
  val PR_ID_PADRE = "pr_id_padre"
  val PR_EDITAR_PRECIOHIJO = "pr_editarpreciohijo"
  val PR_PERMITEEDICION = "pr_permiteedicion"
  val PR_BORRADO = "pr_borrado"
  val PR_STOCKMINIMO = "pr_stockminimo"
  val PR_STOCKMAXIMO = "pr_stockmaximo"
  val PR_CODIGOEXTERNO = "pr_Codigoexterno"
  val PR_CODIGO_BARRA = "pr_codigobarra"
  val PR_CODIGO_BARRA_NAME = "pr_codigobarranombre"
  val PR_REPOSICION = "pr_reposicion"
  val PR_UN_ID_VENTA = "un_id_venta"
  val PR_UN_ID_COMPRA = "un_id_compra"
  val PR_UN_ID_STOCK = "un_id_stock"
  val PR_TI_ID_RI_VENTA = "ti_id_ivariventa"
  val PR_TI_ID_RNI_VENTA = "ti_id_ivarniventa"
  val PR_TI_ID_RI_COMPRA = "ti_id_ivaricompra"
  val PR_TI_ID_RNI_COMPRA = "ti_id_ivarnicompra"
  val PR_TI_ID_INTERNOS_VENTA = "ti_id_internosv"
  val PR_TI_ID_INTERNOS_COMPRA = "ti_id_internosc"
  val PR_CUEG_ID_COMPRA = "cueg_id_compra"
  val PR_CUEG_ID_VENTA = "cueg_id_venta"
  val PR_PESO_TOTAL = "pr_pesototal"
  val PR_PESO_NETO = "pr_pesoneto"
  val UN_ID_PESO = "un_id_peso"
  val PR_CANT_XCAJA_EXPO = "pr_cantxcajaexpo"
  ...
  val PR_NOMBRE_WEB = "pr_nombreweb"
  val PR_NOMBRE_FACTURA = "pr_nombrefactura"
  ...
  val PRDEPF_STOCKMINIMO = "prdepf_stockminimo"
  val PRDEPF_STOCKMAXIMO = "prdepf_stockmaximo"
  ...
  val PRDEPL_STOCKMINIMO = "prdepl_stockminimo"
  val PRDEPL_STOCKMAXIMO = "prdepl_stockmaximo"
