...
object C {
  ...
  val TA_CODE = "ta_codigo"
  val TA_DESCRIP = "ta_descrip"
  val TA_ULTIMO_NRO = "ta_ultimonro"
  val TA_TIPO = "ta_tipo"
  val TA_MASCARA = "ta_mascara"
  val TA_TIPO_AFIP = "ta_tipoafip"
  val TA_PROPUESTO = "ta_propuesto"
  val TA_PUNTO_VTA = "ta_puntovta"
  val TA_CAI = "ta_cai"
...
object S {
  ...
  val NEW_CHEQUERA = 1128
  val EDIT_CHEQUERA = 1129
  val DELETE_CHEQUERA = 1130
  val LIST_CHEQUERA = 1131
