...
object C {
  ...
  val RV_FECHAENTREGA = "rv_fechaentrega"
  val RV_NETO = "rv_neto"
  val RV_IVARI = "rv_ivari"
  val RV_IVARNI = "rv_ivarni"
  ...
  val RV_IMPORTEDESC1 = "rv_importedesc1"
  val RV_IMPORTEDESC2 = "rv_importedesc2"
  ...
  val RVI_CANTIDADAREMITIR = "rvi_cantidadaremitir"
  ...
  val FVI_IVA_RIPORC = "fvi_ivariporc"
  val FVI_IVA_RNIPORC = "fvi_ivarniporc"
  ...
  val REMITO_VENTA_ITEMSERIETMP = "RemitoVentaItemSerieTMP"
