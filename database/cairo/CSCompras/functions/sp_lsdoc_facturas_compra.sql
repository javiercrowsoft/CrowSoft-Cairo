...
-- drop function sp_lsdoc_facturas_compra(integer, timestamp with time zone, timestamp with time zone, varchar, varchar, varchar, varchar, varchar, varchar, varchar);
...
$BODY$
  ...
  cost 100;
alter function sp_lsdoc_facturas_compra(integer, timestamp with time zone, timestamp with time zone, varchar, varchar, varchar, varchar, varchar, varchar, varchar)
  owner to postgres;