...
*/
-- Function: sp_doc_fac_vta_remito_set_pendiente()

-- drop function sp_doc_fac_vta_remito_set_pendiente(integer);

/*
          select * from facturaventa;
          select sp_doc_fac_vta_remito_set_pendiente(1);
*/

create or replace function sp_doc_fac_vta_remito_set_pendiente
(
  in p_fv_id integer
)
  returns void as
...
$BODY$
  ...
  cost 100;
alter function sp_doc_fac_vta_remito_set_pendiente(integer)
  owner to postgres;