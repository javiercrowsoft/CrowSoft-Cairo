...
*/
-- Function: sp_doc_factura_venta_set_estado()

-- drop function sp_doc_factura_venta_set_estado(integer);

create or replace function sp_doc_factura_venta_set_estado
(
  in p_fv_id integer,
...
$BODY$
  ...
  cost 100;
alter function sp_doc_factura_venta_set_estado(integer)
  owner to postgres;