...
-- drop function sp_lsdoc_remitos_venta_cliente(integer, date, date, varchar, varchar, varchar, varchar, varchar, varchar, varchar);
...
$BODY$
  ...
  cost 100;
alter function sp_lsdoc_remitos_venta_cliente(integer, date, date, varchar, varchar, varchar, varchar, varchar, varchar, varchar, varchar)
  owner to postgres;