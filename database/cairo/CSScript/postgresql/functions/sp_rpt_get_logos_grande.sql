...
*/
-- Function: sp_rpt_get_logos_grande()

-- drop function sp_rpt_get_logos_grande(integer);

-- select * from informe where inf_nombre like '%valid%'
-- select * from reporte where inf_id = 34
-- sp_col reporteparametro
/* 
select * from sp_rpt_get_logos_grande( 1 );
fetch all from rtn;
*/
create or replace function sp_rpt_get_logos_grande
(
