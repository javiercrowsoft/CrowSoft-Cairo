...
*/
-- Function: sp_doc_cobranza_editable_get()

-- drop function sp_doc_cobranza_editable_get(integer, integer, integer, integer, integer);
...
$BODY$
  ...
  cost 100;
alter function sp_doc_cobranza_editable_get(integer, integer, integer, integer, integer)
  owner to postgres;