...
*/
-- Function: sp_doc_cobranza_set_credito_cairo()

-- drop function sp_doc_cobranza_set_credito_cairo(integer, integer);

/*
          select * from cobranza;
          select * from sp_doc_cobranza_set_credito_cairo(3,1);
*/

create or replace function sp_doc_cobranza_set_credito_cairo
(
...
$BODY$
  ...
  cost 100;
alter function sp_doc_cobranza_set_credito_cairo(integer, integer)
  owner to postgres;