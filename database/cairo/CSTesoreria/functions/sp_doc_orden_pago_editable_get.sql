...
*/
-- Function: sp_doc_orden_pago_editable_get()

-- drop function sp_doc_orden_pago_editable_get(integer, integer, integer, integer, integer);

create or replace
function sp_doc_orden_pago_editable_get
/*
          select * from ordenpago;
          select * from sp_doc_orden_pago_editable_get(1,101,1);                                  
*/
(
  in p_emp_id integer,
  in p_opg_id integer,
...
$BODY$
  ...
  cost 100;
alter function sp_doc_orden_pago_editable_get(integer, integer, integer, integer, integer)
  owner to postgres;